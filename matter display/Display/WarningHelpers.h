...
inline bool hasHighTemp(const SensorReadings& r)     { return r.temperatureF > 85; }
inline bool hasHighHumidity(const SensorReadings& r) { return r.humidityPercent > 70; }
inline bool hasPoorAQI(const SensorReadings& r)      { return r.aqi > 100; }
